...
#  *     Additional Ubuntu OS packages; NodeJS; ExpressJS web server framework; other Node.js packages; and MySQL.                                     *
#  *                                                                                                                                                   *                                                                                                                                                  *
#  *****************************************************************************************************************************************************
...
class LightsailStack(TerraformStack):
                ...
                for index in range(length):
                    ...
                    ls_instance = LightsailInstance(self, ls_instance_value,
                        ...
                        tags = {
                            ...
                            self.var.get("lightsail_server_tags_keys_version_mysql")[index] : self.var.get("lightsail_server_tags_empty_values")[index],
                        },
    ...
    def confirm_length_of_list_variables(self, variables=None):
        ...
        confirm_three = (len(var.get("lightsail_server_tags_keys_version_nodejs")) == len(var.get("lightsail_server_tags_keys_version_mysql")))
